...
#define NL_CONSTRAST 0.7   // 0.3 low ~ 2.0 high
...
/* Terrain lighting */
#define NL_SUN_INTENSITY 4.9   // 0.5 weak ~ 5.0 bright
...
#define NL_MORNING_SUN_COL vec3(1.4,0.8,0.1)
...
/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.5,0.52,0.18)
#define NL_UNDERWATER_TORCH_COL vec3(1.0,1.0,1.0)
#define NL_NETHER_TORCH_COL     vec3(1.5,1.0,0.18)
...
#define NL_DAY_ZENITH_COL    vec3(0.5,1.7,2.4)
#define NL_DAY_HORIZON_COL   vec3(1.0,1.1,1.2)
#define NL_NIGHT_ZENITH_COL  vec3(0.0,0.1,0.35)
#define NL_NIGHT_HORIZON_COL vec3(0.0,0.9,1.9)
...
#define NL_DAWN_ZENITH_COL   vec3(0.5,0.1,1.0)
#define NL_DAWN_HORIZON_COL  vec3(1.9,0.8,0.20)
#define NL_DAWN_EDGE_COL     vec3(1.9,0.8,0.20)
...
#define NL_LANTERN_WAVE 0.20   // [toggle] 0.05 subtle ~ 0.4 large swing
...
#define NL_WATER_TINT vec3(1.0,2.9,2.4)

/* Underwater */
#define NL_UNDERWATER_BRIGHTNESS 0.8 // 0.0 dark ~ 3.0 bright
#define NL_CAUSTIC_INTENSITY 3.9     // 0.5 weak ~ 5.0 bright
...
#define NL_UNDERWATER_TINT vec3(0.9,1.4,0.9) // fog tint color when underwater
...
#define NL_SUN_BLOOM_COL vec3(1.0,0.0,0.0)
...
#define NL_AURORA_COL2 vec3(0.5,0.0,1.0)
...
/* Sky reflection */
#define NL_GROUND_REFL 0.45      // [toggle] 0.2 slightly reflective ~ 1.0 fully reflect sky 
